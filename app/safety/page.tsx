  ...
  return (
    <section className="mx-auto grid max-w-5xl gap-10 px-4 py-8 sm:px-6 lg:px-8">
      <div className="text-center space-y-4">
        ...
        <h1 className="text-5xl font-black tracking-tight italic uppercase text-foreground">Les 18 Commandements</h1>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {commandements.map((item) => (
          <Card key={item.id} className="p-6 border-foreground/5 bg-card/50 hover:border-accent/40 transition-colors relative overflow-hidden group">
            <span className="absolute -top-2 -right-2 text-6xl font-black text-foreground/5 group-hover:text-accent/10 transition-colors italic">
              {item.id}
            </span>
      ...
      <Card className="p-8 border-red-500/20 bg-red-500/5 mt-6">
        <div className="flex flex-col md:flex-row gap-6 items-center">
          ...
          <div className="text-center md:text-left">
            <h2 className="text-2xl font-bold text-foreground">Zéro tolérance</h2>
